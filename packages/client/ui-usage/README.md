...
- A summary line (total tokens, request count, and web searches over the window) and a Today / 7d / 30d / 90d range selector (Today is the default and requests a one-day window).
