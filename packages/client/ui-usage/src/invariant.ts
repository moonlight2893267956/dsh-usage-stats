 ...
 * one page store, both released by the same effect disposer. The apply spec
 * proves the registration and the store are withdrawn when the owning fiber is
 * disposed, so no second authority exists to check at runtime.
 */
